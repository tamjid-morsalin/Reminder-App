...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("app.events.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('start_date_time') ? 'is-invalid' : '' }}" type="text" name="start_date_time" id="start_date_time" value="{{ old('start_date_time') }}" required>
